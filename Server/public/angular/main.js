...
/* harmony import */ var _services_guard_auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/guard/auth.guard */ 310);
...
class ConfigDetailsComponent {
    ...
    ngOnInit() {
        ...
        if (this.userId && this.configId) {
            ...
            // this.sub2 = this.configService.findById(this.configId).subscribe({
...
class MyconfigsComponent {
  constructor(configService, // private userService: UserHttpService,
  auth, activatedRoute) {
    this.configService = configService;
    this.auth = auth;
    this.activatedRoute = activatedRoute;
...
MyconfigsComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  ...
  dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_4__.NgIf, _angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterLinkWithHref],
...
function NavbarComponent_li_14_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 9)(1, "a", 14);
...
function NavbarComponent_div_17_a_1_Template(rf, ctx) { if (rf & 1) {
...
function NavbarComponent_div_17_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](1, NavbarComponent_div_17_a_1_Template, 2, 1, "a", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](2, NavbarComponent_div_17_a_2_Template, 2, 0, "a", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
...
NavbarComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: NavbarComponent, selectors: [["app-navbar"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵNgOnChangesFeature"]], decls: 18, vars: 4, consts: [[1, "navbar", "navbar-expand-sm", "bg-body-tertiary"], [1, "container-fluid"], ["routerLink", "/", 1, "navbar-brand", "text-yellow"], ["type", "button", "data-bs-toggle", "collapse", "data-bs-target", "#navbarNav", "aria-controls", "navbarNav", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["id", "navbarNav", 1, "collapse", "navbar-collapse"], [1, "navbar-nav"], [1, "nav-item", "text-yellow"], ["aria-current", "page", "routerLink", "/", 1, "nav-link", "active"], [1, "nav-item"], ["routerLink", "/hardwares", 1, "nav-link", "text-yellow"], ["class", "nav-item", 4, "ngIf"], ["class", "nav-item float-end", 4, "ngIf"], [4, "ngIf"], [1, "nav-link", "text-yellow", 3, "routerLink"], [1, "nav-item", "float-end"], ["routerLink", "/login", 1, "nav-link", "text-yellow"], ["class", "nav-link d-inline", 4, "ngIf"], ["class", "nav-link text-yellow", "routerLink", "/", 3, "click", 4, "ngIf"], [1, "nav-link", "d-inline"], ["routerLink", "/", 1, "nav-link", "text-yellow", 3, "click"]], template: function NavbarComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](14, NavbarComponent_li_14_Template, 3, 3, "li", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](15, NavbarComponent_li_15_Template, 3, 3, "li", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](16, NavbarComponent_div_16_Template, 3, 0, "div", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](17, NavbarComponent_div_17_Template, 3, 2, "div", 13);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()();
    } if (rf & 2) {
